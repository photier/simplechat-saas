...
title: "Built on Telegram. Built for speed and scale."
  ...
  - title: "Unlimited seats. One simple price."
    ...
    bulletpoints_x:
      ...
      - icon: "/images/icons/svg/code.svg"
        ...
        description: "Add AI replies for just $19.99/month when you're ready. Keep it off if you prefer 100% human support."
    button:
      enable: true
