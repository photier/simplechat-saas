...
export const HeroStatsCards = ({ data, loading }: HeroStatsCardsProps) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3" style={{ gap: '25px' }}>
      ...
      <div
        className="rounded-xl p-6 transition-all duration-300 hover:-translate-y-1 cursor-pointer animate-fade-in"
        style={{
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-semibold text-gray-700 mb-1">{t('hero.onlineNow')}</p>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-semibold text-gray-700 mb-1">{t('hero.totalImpressions')}</p>
            <p className="text-5xl font-bold text-gray-900 mb-2">
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-semibold text-gray-700 mb-1">{t('hero.conversionRate')}</p>
            <p className="text-5xl font-bold text-gray-900 mb-2">
              {loading ? '...' : `${data?.conversionRate || 0}%`}
            </p>
            <p className="text-xs text-gray-600">{t('hero.openersTalkers')}</p>
          </div>
