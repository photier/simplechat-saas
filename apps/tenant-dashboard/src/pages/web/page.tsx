...
import { useUsers } from '../layout-8/hooks/useUsers';
import { UsersTable } from '../layout-8/components/UsersTable';
...
export function Layout8WebPage() {
  ...
  return (
    <PageTransition>
      ...
      <div className="container px-8 lg:px-12 pb-12">
        <UsersTable users={users} loading={loading} channelType="web" />
      </div>
    </PageTransition>
  );
}
